  ...
  return (
    <>
      ...
      <main id="main" style={{ padding: 'var(--page-padding)' }}>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--glitch-purple)', color: 'var(--paper-white)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[COLORS]</div>
          <h2>Colors</h2>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--paper-white)', color: 'var(--foundation-black)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[LAYOUT]</div>
          <h2>Layout</h2>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--status-green)', color: 'var(--foundation-black)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[TYPOGRAPHY]</div>
          <h2>Typography</h2>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--system-blue)', color: 'var(--paper-white)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[COMPONENTS]</div>
          <h2>Components</h2>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--digital-yellow)', color: 'var(--foundation-black)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[VERBIAGE & TONE]</div>
          <h2>Verbiage & Tone</h2>
        ...
        <section tabIndex={0} style={{ border: 'var(--border-thick)', boxShadow: 'var(--shadow-heavy)', padding: '16px', margin: '16px 0', backgroundColor: 'var(--paper-white)', color: 'var(--foundation-black)' }}>
          <div style={{ fontFamily: 'var(--mono-font)', marginBottom: '8px' }}>[STYLE]</div>
          <h2>Style</h2>

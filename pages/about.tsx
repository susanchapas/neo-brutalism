    ...
    <>
      ...
      <main id="main">
        ...
        <div className={aboutStyles.container}>
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.color}`}>
          ...
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.layout}`}>
          ...
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.typography}`}>
          ...
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.components}`}>
          ...
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.verbiage}`}>
          ...
          <section tabIndex={0} className={`${aboutStyles.card} ${aboutStyles.style}`}>

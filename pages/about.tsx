...
const AccordionItem = ({ title, content, style, isOpen, onClick }: { title: string, content: string, style: string, isOpen: boolean, onClick: () => void }) => (
  <div>
    <button
      aria-expanded={isOpen}
      className={`${aboutStyles.accordionButton} ${style} ${isOpen ? aboutStyles.active : ''}`}
      onClick={onClick}
    >
      {title}
    </button>

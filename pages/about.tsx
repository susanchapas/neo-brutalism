  ...
  return (
    <>
      ...
      <main id="main" style={{ padding: 'var(--page-padding)' }}>
        ...
        <section tabIndex={0} className={cardStyles.neo_brutalist_card} style={{ backgroundColor: 'var(--paper-white)', color: 'var(--foundation-black)', margin: '16px 0' }}>
        ...
        <section tabIndex={0} className={cardStyles.neo_brutalist_card} style={{ backgroundColor: 'var(--status-green)', color: 'var(--foundation-black)', margin: '16px 0' }}>
        ...
        <section tabIndex={0} className={cardStyles.neo_brutalist_card} style={{ backgroundColor: 'var(--system-blue)', color: 'var(--paper-white)', margin: '16px 0' }}>
        ...
        <section tabIndex={0} className={cardStyles.neo_brutalist_card} style={{ backgroundColor: 'var(--digital-yellow)', color: 'var(--foundation-black)', margin: '16px 0' }}>

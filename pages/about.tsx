    ...
    <>
      ...
      <main id="main">
        ...
        <div className={aboutStyles.container}>
          <section className={`${aboutStyles.section} ${aboutStyles.colors}`}>
          ...
          <section className={`${aboutStyles.section} ${aboutStyles.layout}`}>
          ...
          <section className={`${aboutStyles.section} ${aboutStyles.typography}`}>
          ...
          <section className={`${aboutStyles.section} ${aboutStyles.components}`}>
          ...
          <section className={`${aboutStyles.section} ${aboutStyles.verbiage}`}>
          ...
          <section className={`${aboutStyles.section} ${aboutStyles.style}`}>
